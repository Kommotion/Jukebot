...
"""This module was created by Rapptz/Danny. All credit goes to him"""
...
class Tags(Cog):
    ...
    async def tag(self, ctx, *, name : str):
        """Allows you to tag text for later retrieval. Try out `tag make`!

        If a Command is not called, then this will search the tag database
    ...
    async def make(self, ctx):
        ...
        await self.config.put(location, db)
        await self.bot.say('Done. I\'ve made your {0.content} tag.'.format(name))
